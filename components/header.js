...
const Header = () => {
  ...
  const [subMenuClosed, setSubMenuClosed] = useState(true);
  const [subMenuDoubleClosed, setSubMenuDoubleClosed] = useState(true);
  ...
  return (
    <header className="header">
      <div className="header__wrapper">
        ...
        <nav className={`header__main-nav main-nav` + (menuClosed ? ` main-nav--closed` : ` main-nav--opened`)}>
          <button
            onClick={() => {
              setMenuClosed(!menuClosed);
            }}
            className="main-nav__toggle" type="button"></button>
          <ul className="main-nav__list site-list">
            ...
            <li
              onMouseEnter={() => {
                isDesktop && subMenuClosed ? setSubMenuClosed(false) : null
              }}
              onMouseLeave={() => {
                isDesktop ? setSubMenuClosed(true) : null
              }}
